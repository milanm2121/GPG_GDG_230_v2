...
public class CardDataBase : MonoBehaviour
{
    ...
    private void Awake()
    {
        cardList.Add(new CardVersion2(0, "Trooper Token", "I dont exist in the deck", "Soldier", 1, 3, 3, Resources.Load <Sprite>("0"), 0, 0, 0, 0, 0, false, 0 , 0, false, 0, false));
        ...
        cardList.Add(new CardVersion2(21, "Storm in Trooper", "Give all Solider unit +1/+1", "Spell", 3, 0, 0, Resources.Load<Sprite>("6"), 0, 0, 0, 0, 2, false, 1, 1, false, 0, true));
        ...
        cardList.Add(new CardVersion2(21, "Storm in Trooper", "Give all Solider unit +1/+1", "Spell", 3, 0, 0, Resources.Load<Sprite>("6"), 0, 0, 0, 0, 0, false, 1, 1, false, 0, false));
        cardList.Add(new CardVersion2(22, "Training Camp", "Draw 1 Card", "French", 4, 2, 5, Resources.Load<Sprite>("1"), 0, 0, 0, 0, 0, false, 0, 0, false, 0, false));
